...
class SimpleTemplateCachingSiteConfigExtension extends Extension
{
    ...
    private static string $image_cache_directive = '<IfModule mod_headers.c> <FilesMatch "\.(jpg|jpeg|png|gif|webp|svg)$"> Header set Cache-Control "public, max-age=3600" </FilesMatch> </IfModule>';

    private static string $css_and_js_cache_directive = '<IfModule mod_headers.c> <FilesMatch "\.(js|css|)$"> Header set Cache-Control "public, max-age=3600" </FilesMatch> </IfModule>';
